...
public sealed class UrlServiceV1 : IUrlServiceV1
{
    ...
    public UrlServiceV1(IUrlRepository urlRepository)
    {
    ...
    private async Task<string> GenerateUniqueSlugAsync(CancellationToken cancellationToken)
    {
        ...
        {
            // ✅ Generate Base62 slug using timestamp + random
            var slug = _encoder.GenerateBase62Slug();
